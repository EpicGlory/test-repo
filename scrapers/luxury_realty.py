...
class LuxuryRealtyScraper(BaseScraper):
    ...
    def __init__(self, config: dict):
        ...
        self.known_builders = [b.get("name", "") for b in config.get("builders", []) if b.get("name")]
    ...
    def _extract_detail_page(
        ...
        # Check if this is a target-area property
        if not any(loc in text_lower for loc in self.target_keywords):
            return []
    ...
    def _extract_subdivision(self, text: str) -> str:
        ...
        return lu.detect_subdivision(text, self.config)
    ...
    def _extract_builder(self, text: str) -> str:
        ...
        text_lower = text.lower()
        for builder in self.known_builders:
